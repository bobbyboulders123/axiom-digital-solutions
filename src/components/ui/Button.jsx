...
const Button = ({ children, onClick, className = '', variant = 'primary' }) => {
  ...
  const variants = {
    primary: "bg-white text-[#0B0F14] font-semibold border border-transparent shadow-[0_0_20px_rgba(53,208,255,0.2)] hover:shadow-[0_0_30px_rgba(47,128,237,0.4)]",
    secondary: "bg-[#1B2430]/60 text-white font-medium border border-steel/20 hover:border-steel/40 backdrop-blur-md"
  }
