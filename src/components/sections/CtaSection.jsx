...
const CtaSection = () => {
  return (
    <section className="py-32 px-6 bg-[#0B0F14] relative overflow-hidden flex flex-col items-center justify-center text-center">
      ...
      <div className="max-w-3xl relative z-10">
        ...
        <p className="text-steel text-lg md:text-xl mb-12 max-w-2xl mx-auto">
          Partner with Axiom Digital Solutions to replace your generic website with a high-performance, premium digital experience.
        </p>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-40 mix-blend-screen" 
           style={{ backgroundImage: 'linear-gradient(rgba(124, 138, 153, 0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(124, 138, 153, 0.1) 1px, transparent 1px)', backgroundSize: '80px 80px' }}>
      </div>
    </section>
  )
}
